...
def battlingstory():
    ...
    input("Tristan was never called into the battle against Asunder because the king thought they would surely win. \n But with the advances thanks to the 'Alpha Powers', their army started to grow weaker.")
    print("")
    print("")
...
def finaleone():
    ...
    input("Naomi: No... it can't be. He was banished long ago, right?")
